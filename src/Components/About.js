...
export default function About(props){
    return (
        <div className="about">
            <h1>About Me</h1>
            <p>My name's Brannon & I'm from Australia. Writing computer programs is a passion of mine. This website helps me showcase some of the work I do, and it allows me to write about things that I'm interested in.</p>
            <p>After studying IT security at university, I've come to learn I don't only have a passion for software & computers, but I also have a passion for securing them.</p>
            <p>
